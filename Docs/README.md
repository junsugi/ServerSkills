...
|Concurrency|JobQueue / Ownership Model|
|Architecture|PacketSession / Handler / Service|
|Testing|DummyClient Load Test|
...
플레이어 이동 시 발생하는 Broadcast fan-out 비용을 측정하고,  
AOI(Interest Management)를 적용해 전송 비용을 감소시켰습니다.
